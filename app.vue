<template>
    <div class="container">
        ...
        <form class="mb-3 mt-3">
            ...
            <button disabled type="submit" class="btn btn-primary">Entrar</button>
        </form>
        <ul>
            <li>
                <NuxtLink to="/register">Ainda não tem uma conta?</NuxtLink>
            </li>
            <li>
    ...
    <div class="container">
        ...
        <form>
            ...
            <button disabled type="submit" class="btn btn-primary">Criar Conta</button>
        </form>
